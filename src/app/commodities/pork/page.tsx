...
export default async function PorkCommoditiesPage() {
  const products = await getPorkProducts();
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 sm:mt-10 text-center">
              ...
              <p className="mt-4 text-base sm:text-lg max-w-3xl mx-auto text-gray-500 dark:text-gray-400">
                Premium pork cuts and by-products selected for global trade. Explore all available items and request
                a quote with our team.
              </p>
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <QuoteProductButton commodityCategory="pork" commodityProduct={product.name} />
                  </div>
                </article>
              ))}
            </div>
