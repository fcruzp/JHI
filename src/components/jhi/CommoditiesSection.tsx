...
const commodities = [
  { key: 'Sugar', image: '/images/sugar.png' },
  { key: 'Meat', image: '/images/meat.png' },
  { key: 'Grains', image: '/images/grains.png' },
  { key: 'Coffee', image: '/images/coffee.png' },
  { key: 'Oil', image: '/images/oil.png' },
  { key: 'Dairy', image: '/images/dairy.png' },
] as const;
